...
```json
{
  "applicationName" : "DotNet HelloWorld",
  "projectName" : "dotnet-hello-world"
}
```
## Log
```
...
┃ ┃ ┃ Debug Adding symbol compilerSafeAppName with value 'DotNet HelloWorld'
...
┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [Sample->DotNet HelloWorld]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ Debug Path 'Sample.csproj' matched '^(?<folder>.*/)?(?<filename>([^/]+?|)(?=(?<ext>\.[^/.]*)?)$)' with groups {ext=.csproj, folder=null, filename=Sample.csproj, g0=Sample.csproj, g1=null, g2=Sample.csproj, g3=Sample.csproj, g4=.csproj} and was rewritten to 'DotNet HelloWorld.csproj'
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [sample-app->dotnet-hello-world]
